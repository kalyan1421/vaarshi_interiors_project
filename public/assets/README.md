...
**IMPORTANT:** Assets must be placed in `client/public/assets/` (not root `public/assets/`)
...
1. Place your video file in: `client/public/assets/videos/`
2. Place your images in: `client/public/assets/images/`
3. Ensure filenames match exactly as specified above
4. Restart the development server if needed

**Note:** Vite serves files from the `client/public` directory, not the root `public` directory.
